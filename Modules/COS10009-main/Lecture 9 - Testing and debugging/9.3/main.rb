...
class Game < Gosu::Window
  ...
  def initialize
    ...
    @start_music = Gosu::Song.new('music/Lost Frontier.ogg')
  ...
  def initialize_game
    ...
    #------------------------Bullet init------------------------
    @bullets = []
    @shooting_sound = Gosu::Sample.new('music/shoot.ogg')
    #------------------------Explosion init------------------------
    @explosions = []
    @explosion_sound = Gosu::Sample.new('music/explosion.ogg')
  ...
  def initialize_end(fate)
    ...
    @scene = :end
    @end_music = Gosu::Song.new('music/FromHere.ogg')
    @end_music.play(true)
  end
#----------------------------------------------------------------------
